	...
	RegisterNUICallback('register', function(data, cb)
		ESX.TriggerServerCallback('esx_identity:registerIdentity', function(callback)
			if callback then
				...
				if not ESX.GetConfig().Multichar then TriggerEvent('esx_skin:playerRegistered') end TriggerEvent('esx_skin:openSaveableMenu', function() finished = true end, function() finished = true end)
			else
